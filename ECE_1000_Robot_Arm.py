...
#Originally created by JC Williams modified by Alexander Bussell (awbussell42@tntech.edu)
...
#added y servo
servo_y = PWM(Pin(0), freq=50)
servo_x = PWM(Pin(1), freq=50)
servo_switch = PWM(Pin(2), freq = 50)
